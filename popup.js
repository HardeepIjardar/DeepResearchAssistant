...
class DeepResearchPopup {
    ...
    async getAIResponse(message) {
        ...
        if (lowerMessage.includes('hello') || lowerMessage.includes('hi')) {
            ...
            return "I can help you summarize the current page content. Let me analyze the page and provide you with a concise summary.";
        } else if (lowerMessage.includes('explain') || lowerMessage.includes('what is')) {
            return "I'd be happy to explain that topic! Let me gather some information and provide you with a detailed explanation.";
        } else {
            return "That's an interesting question! I'm here to help you research and find information. Could you provide more context about what you'd like to know?";
        }
    }
